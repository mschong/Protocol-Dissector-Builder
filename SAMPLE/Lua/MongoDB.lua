...
response_to = ProtoField.int32('MongoDB.response_to',responseTo,base.) 
        ...
        local flags_description = get_flag_description(flags_number)
	 	 	 ...
	 	 	 local string_length
                ...
                break
 	 	 	 	...
 	 	 	 	subtree:add_le(full_coll_name,buffer(20,1)) 
	 	 	 subtree:add_le(number_to_skip,buffer(21,4)) 
	 	 	 subtree:add_le(number_to_return,buffer(25,4)) 
	 	 	 subtree:add_le(query,buffer(29,1)) 
